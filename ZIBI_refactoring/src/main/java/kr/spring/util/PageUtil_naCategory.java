...
public class PageUtil_naCategory {
	 ...
	 * */
	public PageUtil_naCategory(int currentPage,int count, int rowCount) {
	...
	public PageUtil_naCategory(int currentPage, int count, int rowCount, int pageCount, String pageUrl) {
		this(null,null,currentPage,count,rowCount,pageCount,pageUrl,null);
	}
	public PageUtil_naCategory(int currentPage, int count, int rowCount, int pageCount, String pageUrl, String addKey) {
		this(null,null,currentPage,count,rowCount,pageCount,pageUrl,addKey);
	}
	public PageUtil_naCategory(String keyfield, String keyword, int currentPage, int count, int rowCount, int pageCount,String pageUrl) {
		this(keyfield,keyword,currentPage,count,rowCount,pageCount,pageUrl,null);
	}
	public PageUtil_naCategory(String keyfield, String keyword, int currentPage, int count, int rowCount, int pageCount,String pageUrl,String addKey) {

		if(count >= 0) {
			String sub_url = "";
			if(keyfield != null) sub_url = "&category="+keyfield;
