...
<div class="member-page policy-page page-width">
	<form:form action="policyInsert" modelAttribute="policyVO">
		<input type="hidden" value="${policyVO.district_num}" name="district_num" id="district_num">
		<div class="row">
			<div class="col-12">
				<p>행정구역명</p>
				<form:input path="district_name" class="form-control"/>
				<form:errors path="district_name"/>
			</div>
		</div>
		<div class="row">
		...
		<div class="row">
			<form:button class="btn mem-btn-green">등록</form:button>
		</div>
	</form:form>
</div>
